...
<body>
  <div class="title-box">9 Hari Lagi Kak Thania Theresia Podung Ulang Tahun! 🎉🎂🥳</div>
  ...
  <div id="photo-gallery" class="photo-gallery" style="display: none;">
    <div class="gallery-container">
      <img src="foto 20.jpeg" class="gallery-photo">
    </div>
  </div>

  <script>
    const audio = new Audio('Seventeen-Fire.mp3');
    ...
    const fullMessage = `"Jadi hari sabtu ini ada rapat koordinasi cuma kak nia nda hadir, kong pas malam itu Queen aneh skli cuma gara-gara pamflet fellow queen ada chat capslock pa kak nia wkwkwkwkwk memang aneh skli bae kak nia baik hati dan tidak gampang marah anjayyy, SEMANGATTTTTT TERUSSSSSS KAK NIAAAAAA`;
